<template>
  ...
  >
    ...
    >
      <a class="hover:text-yellow-300 transition duration-300" href="https://www.linkedin.com/in/rayasabari/">
        <font-awesome-icon :icon="['fab','linkedin']" />
      </a>
      <a class="hover:text-yellow-300 transition duration-300" href="https://instagram.com/rayasabari">
        <font-awesome-icon :icon="['fab','instagram']" />
      </a>
      <a class="hover:text-yellow-300 transition duration-300" href="https://www.facebook.com/rayasabari">
        <font-awesome-icon :icon="['fab','facebook']" />
      </a>
      <a class="hover:text-yellow-300 transition duration-300" href="https://twitter.com/rayasabari">
